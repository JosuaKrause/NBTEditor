...
public class NBTModel implements TreeModel {
    ...
    public Object getChild(final Object parent, final int index) {
        ...
        if (parent instanceof NBTList) {
            return ((NBTList) parent).getAt(index);
        }
        return null;
    }
    ...
    public int getChildCount(final Object parent) {
        if (parent instanceof NBTCompound) {
            return ((NBTCompound) parent).size();
        }
        if (parent instanceof NBTList) {
            return ((NBTList) parent).getLength();
        }
        return 0;
    }
    ...
    public int getIndexOfChild(final Object parent, final Object child) {
        ...
        if (parent instanceof NBTCompound) {
            return ((NBTCompound) parent).indexOf(c);
        }
        if (parent instanceof NBTList) {
            return ((NBTList) parent).indexOf(c);
        }
        return -1;
    }
